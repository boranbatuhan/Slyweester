...
<div class="w-full border-b ">
  ...
  <path d="m13.41 11.996 4.3-4.29a1.004 1.004 0 1 0-1.42-1.42l-4.29 4.3-4.29-4.3a1.004 1.004 0 0 0-1.42 1.42l4.3 4.29-4.3 4.29a.999.999 0 0 0 0 1.42 1 1 0 0 0 1.42 0l4.29-4.3 4.29 4.3a1.001 1.001 0 0 0 1.639-.325 1 1 0 0 0-.22-1.095l-4.3-4.29Z"></path>
            ...
            <tag v-show="tagContent !=''" :tag="tagContent" class="!absolute -top-3 left-10"></tag>
            ...
            <input @click="slywetle" :disabled="slywetContent=='' || openTagInput==true " type="submit" value="slywetle" class="  disabled:saturate-0 font-semibold disabled:pointer-events-none disabled:opacity-75 px-4 cursor-pointer py-1  bg-sl-blue text-white rounded-full">
        </form>
    </div>
</div>
</template>